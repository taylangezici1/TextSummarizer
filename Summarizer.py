...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.pushButton.setGeometry(QtCore.QRect(300, 450, 91, 21))
        font = QtGui.QFont()
        ...
        self.label_2.setGeometry(QtCore.QRect(360, 20, 91, 21))
        font = QtGui.QFont()
        font.setFamily("Kanit")
        font.setPointSize(12)
        ...
        self.textEdit.setGeometry(QtCore.QRect(80, 20, 261, 411))
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.textEdit_2.setGeometry(QtCore.QRect(450, 20, 231, 411))
        font = QtGui.QFont()
        font.setPointSize(8)
    ...
    def retranslateUi(self, Form):
        ...
        self.pushButton.setText(_translate("Form", "Summarize"))
    ...
    def yap(self):
        ...
        for i in range(len(sentences)):
            for j in range(len(sentences)//2):
                if sentences[i] == ranked_sentences[j][1]:
                    summary += str(ranked_sentences[j][1])
